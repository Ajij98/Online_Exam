<?php
 ...
 <?php
  ...
  if(isset($_POST['submit']))
  {
    ...
    $sql = "SELECT * FROM tb_teacher WHERE BINARY username = '$teacher_username' AND BINARY password = '$password' LIMIT 1";
    ...
    if($result->num_rows != 0)
    {
      ...
      header('location:Teacher_Panel/HTML/index.html');
    }
    else
    {
...
<body style="background-color: #A9CCE3;">
  ...
  <section id="teacher_login_form" class="col-lg-6 col-md-6 m-auto">
    <div class="container">
      <div class="row">
        <div class="col">
