<?php
 ...
 <?php
  ...
  if(isset($_POST['submit']))
  {
    ...
    $sql = "SELECT * FROM tb_student WHERE BINARY username = '$admin_username' AND BINARY password = '$password' LIMIT 1";
...
<body style="background-color: #A9CCE3;">
  ...
  <section id="admin_login_form" class="col-lg-6 col-md-6 m-auto">
    <div class="container">
      <div class="row">
        <div class="col">
